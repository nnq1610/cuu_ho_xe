...
const Register = () => {
  ...
  const validateForm = () => {
    let valid = true;
    const phoneRegex = /^\+?[0-9]{10,15}$/; // Hợp lệ với số điện thoại từ 10-15 chữ số, có thể bắt đầu bằng dấu +
    const newErrors = {
      name: !formData.name,
          ...
          <form id="registrationForm" onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-4">
              ...
              <input
                  ...
                  required
              />
              {errors.email && <p className="text-red-500 text-sm mt-2">Email không hợp lệ.</p>}
            </div>
            <div className="mb-4">
              ...
              <input
                  ...
                  required
              />
              {errors.password && <p className="text-red-500 text-sm mt-2">Vui lòng nhập mật khẩu.</p>}
            </div>
            <div className="mb-4">
